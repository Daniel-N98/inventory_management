...
export function getInvitationEmailHTML(inviteeName: string, inviterName: string, invitationLink: string) {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
            ...
            <tr>
              <td style="padding: 24px; color: #111827;">
                ...
                <p style="font-size: 16px; margin-bottom: 24px;">
                  <strong>${inviterName}</strong> has invited you to join <strong>InvManager</strong>.
                </p>
